...
- <img src="https://ilovevideoeditor.com/favicon.svg" height="14"/> [iLoveVideoEditor](https://github.com/ilovevideoeditor/mcp-server) - Render real MP4 videos from JSON scene definitions or 249 motion-design templates: list templates, fill variables, submit render jobs, poll status, and get download URLs.
